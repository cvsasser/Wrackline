...
export const SAMPLE_SHELLS: SampleShell[] = [
  {
    ...
    sampleData: {
      visualAnalysis: 'Observed classic spindle-shaped gastropod body whorl with 7 distinct horizontal rows of dark mahogany-brown square spots over an off-white glossy background shell surface. Tapered spire and smooth aperture lip.',
      isValidSpecimen: true,
      isValidShell: true,
      specimenType: 'seashell',
      commonName: 'Junonia Volute',
      commonAliases: ['Peacock Shell', 'Spotted Volute', 'Holy Grail Shell'],
      scientificName: 'Scaphella junonia',
      family: 'Volutidae',
      confidence: 0.96,
      rarity: 'rare',
  ...
  },
  {
    ...
    sampleData: {
      visualAnalysis: 'Observed heavy spiny crown around spire, large triangular body whorl, and dramatically flared aperture lip with vibrant glossy pink-orange interior coloration.',
      isValidSpecimen: true,
      isValidShell: true,
      specimenType: 'seashell',
      commonName: 'Queen Conch',
      commonAliases: ['Pink Conch', 'Caribbean Conch'],
      scientificName: 'Aliger gigas',
      family: 'Strombidae',
      confidence: 0.98,
      rarity: 'uncommon',
  ...
  },
  {
    ...
    sampleData: {
      visualAnalysis: 'Observed fan-shaped bivalve shell with equal auricles (ears) at the hinge, ~20 prominent radial ribs, and irregular calico-pink and reddish mottling.',
      isValidSpecimen: true,
      isValidShell: true,
      specimenType: 'seashell',
      commonName: 'Calico Scallop',
      commonAliases: ['Mottled Fan Shell', 'Speckled Scallop'],
      scientificName: 'Argopecten gibbus',
      family: 'Pectinidae',
      confidence: 0.94,
      rarity: 'common',
  ...
  },
  {
    ...
    sampleData: {
      visualAnalysis: 'Observed flattened disc-shaped echinoid test with 5 distinct slot-like lunules and a 5-petal flower pattern centered around the apical system.',
      isValidSpecimen: true,
      isValidShell: true,
      specimenType: 'seashell',
      commonName: 'Keyhole Sand Dollar',
      commonAliases: ['Five-Hole Sand Dollar', 'Sea Biscuit'],
      scientificName: 'Mellita quinquiesperforata',
      family: 'Mellitidae',
      confidence: 0.91,
      rarity: 'common',
